        ...
        <div className="flex w-[940px] h-[455px] gap-5 ml-6 mb-10">
          <div className="w-[300px] h-[455px] bg-[#DDD6FE] rounded-[20px] mt-[100px] shadow-md p-6 flex flex-col justify-between">
            ...
            <div>
              ...
              <p className="text-[16px] leading-6 text-center w-[242px] h-[168px] text-gray-700">
                Skipping moisturizer can actually make oily skin worse! When
                your skin is dehydrated, it produces even more oil to
                compensate. Choose a light, oil-free moisturizer to maintain
                balance.
              </p>
            </div>
          ...
          <div className="w-[300px] h-[455px] bg-[#DDD6FE] rounded-[20px] mt-[100px] shadow-md p-6 flex flex-col justify-between">
            ...
            <div>
              ...
              <p className="text-[16px] leading-6 text-center w-[242px] h-[168px] text-gray-700">
                Price doesn’t always reflect effectiveness. Many affordable
                products contain the same active ingredients found in high-end
                skincare. It’s all about finding the right ingredients for your
