  ...
  return (
    <div className="w-[390px] mx-auto h-[844px] bg-[#D8ECE0] mt-3 pt-1">
      ...
      <div className="px-6 py-2 mt-7">
        ...
        <p  className="text-[16px] mb-4">Accelerate skin renewal, boost collagen production, and reduce fine lines and wrinkles.
             Retinoids are derivatives of Vitamin A and are considered one of the most effective anti-aging ingredients.</p>
        <p className="text-[16px] font-bold">Usage</p>
        <p  className="text-[16px] mb-4">Start with lower concentrations to assess skin tolerance and gradually increase. 
            Use at night and apply sunscreen during the day as retinoids can increase sun sensitivity.</p>
        <p className="text-[16px] font-bold">Note</p>
        <p  className="text-[16px] mb-4">Retinoids can be strong, so it’s best to start with a lower concentration to minimize irritation 
            and gradually build tolerance.</p>
          </div>
      </div>
    </div>
  );
