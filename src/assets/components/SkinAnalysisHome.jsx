...
export default function SkinAnalysisHome(){
    ...
    return(
      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-700 text-[14px] h-[66px] w-[196px] mt-1">
          Our AI provide more accurate  and personalized analysis with your health data.
        </p>
        </div>
    ...
    <button className="bg-[#FBBF24] hover:bg-yellow-500 text-gray-800 px-[28px] py-[8px] mt-4 ml-4 w-[350px] h-[44px] 
          rounded-[6px] text-[16px] font-medium transition-colors duration-200" onClick={handleButtonClick}>
            Analyze My Skin Now
          </button>
          <p className="ml-4 mt-4 font-semibold text-[18px]">Your Skin Analysis History</p>
          ...
          <div className="w-[350px] hover:cursor-pointer h-[132px] bg-[#F4F7F2] border border-[#9E9E9E] ml-4 rounded-2xl p-4 flex gap-4 mt-3"
          onClick={handleClick}>
      <img src={faceIcon} className="w-[52px] h-[52px]" />
      <div className="flex flex-wrap justify-between w-full">
        <div className="flex flex-col">
          <span className="text-[12px]">Skin Score</span>
          <span className="text-[18px] font-semibold">78 <span className="text-lg font-medium">/100</span></span>
        </div>
        <div className="flex flex-col">
          <span className="text-[12px]">Skin Age</span>
          <span className="text-[18px] font-semibold">12 <span className="text-lg font-medium">years younger</span></span>
        </div>
    ...
    <div className=" bottom-0 w-[390px]  bg-[#303030] fixed  px-5 py-4 flex justify-around items-center">
          <div className="flex flex-col items-center text-white hover:cursor-pointer" onClick={handleHomeClick}>
