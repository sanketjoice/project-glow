      ...
      <div className="w-[390px] h-[680px] overflow-auto rounded-xl shadow-lg flex flex-col bg-white">
        ...
        <div className="flex items-center justify-between px-4 py-4">
          <img
            ...
            alt="Left Arrow"
          />
          <img src={logo} alt="GlowSkin Logo" className="w-[110px] h-[28px] mr-[20px]" />
          <img
            src=""
            alt=""
          />
        </div>
        <h6 className="text-[24px] leading-[30px] text-center w-[320px] h-[30px] font-semibold justify-center 
        items-center mt-10 ml-[30px]">Sign into your account</h6>
         <div className="w-[326px] h-[108px] gap-[12px] flex flex-col items-center self-center mt-14 ">
          <input type="text" placeholder="Email" className="h-[48px] w-[326px] gap-1 text-[#9CA3AF] px-4 py-1 
          border-gray-00 border"  />
          <input type="text" placeholder="Password" className="h-[48px] gap-1 w-[326px] text-[#9CA3AF] px-4 py-1
           border-gray-00 border" />
          </div>
        {/* Footer Buttons */}
        ...
        <button
          ...
          <div className="flex self-center gap-0 mt-0">
            <p className="text-[14px] leading-[22px] h-[22px] hover:cursor-pointer w-[152px]"
            onClick={handleNextClick}>Don’t have an account,</p> 
          </div>
        </div>
      </div> 
