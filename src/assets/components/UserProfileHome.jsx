                    ...
                    <div className="flex items-center justify-between mt-1 py-[16px]">
                      ...
                      <div></div>
                        ...
                        <div className="mt-7 justify-center m-auto flex flex-col text-center">
                            <div className=" bg-[#303030] h-[80px] w-[80px] rounded-[200px] text-white text-[32px]
                             text-center justify-center items-center align-middle m-auto flex font-semibold">JC</div>
                             <h6 className="text-[24px] mt-1 ">Jane Chan</h6>
                        </div>
                        {/* Account Section */}
                        <div className="w-[330px] bg-[#F4F7F2] rounded-xl mt-[50px]  pl-4">
      {[ 
        { icon: <img src={MyAccountIcon} alt="My Account" />, label: "My Account" },
        { icon: <img src={ComprehensiveLevelIcon} alt="Comprehensive Level" />, label: "Comprehensive level", extra: "Currently: ", value: "60%" },
        { icon: <img src={SubscriptionIcon} alt="Subscription" />, label: "Subscription" },
        { icon: <img src={RewardsIcon} alt="Rewards" />, label: "Rewards" },
        { icon: <img src={InviteFriendIcon} alt="Invite a Friend" />, label: "Invite a Friend" },
        { icon: <img src={SupportIcon} alt="Support" />, label: "Support" }
      ].map((item, index) => (
        <div key={index} className="flex items-center justify-between  border-t border-gray-400 py-3 last:border-b-0">
          ...
          <img src={leftArrow} alt="Right Arrow" className="w-4 rotate-180 h-4" />
        </div>
      ))}
    </div>
                    </div>
