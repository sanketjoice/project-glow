  ...
  return (
    <div className="flex justify-center items-center h-auto bg-gray-100">
      ...
      <div className="space-y-4">
        {/* Ingredient items */}
        <div className="border-b border-gray-300 hover:cursor-pointer" onClick={handleClick}>
        ...
        <div className="border-b border-gray-300 hover:cursor-pointer" onClick={handleClickVitamin}>
        ...
        <div className="border-b border-gray-300">
          ...
          <div className="border border-black  w-[314px]"></div>
            ...
            <div className="bg-[#EDD8BA] flex flex-col mt-8 ml-[-16px] w-[350px] h-[146px] pl-5 pr-1 pt-5 hover:cursor-pointer rounded-[10px]"
            onClick={handleTextClick}>
              <div className="w-[310px] h-[106px]">
                <p className="text-[16px] mb-2 font-bold">Skincare Insights</p>
                <p classname="text-[14px] leading-[22px] w-[280px] h-[70px]">As skin ages, it loses its flexibility and can no longer spring back. These grooves then become 
                features of the face, which...</p>
                </div>
                <div className="bg-[#E6EEF0] pb-[100px] mb-[100px] pl-5 pr-1 pt-5 w-[350px] ml-[-20px] h-[490px] mt-[55px] rounded-[10px]">
                  ...
                  <p className="text-[14px] mt-2">We found 2 products suitable for you.</p>
                  <div className="w-[310px] h-[180px] mt-3 border-b border-[#CED4DA] py-[20px] flex"> 
                    <div>
                      <img src={productOne} alt="productLogo" className="w-[100px] h-[100px] mb-2" />
                      <div className="w-[100px] h-[28px] bg-[#22AD5C] rounded-lg px-[30px] py-[4px] text-white
                      text-[14px] font-semibold">9.5/10</div>
                    </div>
                    <div className="ml-5">
                      <p className="text-[14px] mb-2">ALPYN</p>
                      <p className="text-[16px] font-semibold">Super Peptide & Ghostberry Barrier Repair Cream</p>
                      <p className="text-[14px] text-[#1A8245] mt-3 font-semibold">Suitable for you!</p>
                    </div>
                  </div>
                  <div className="w-[310px] h-[180px] mt-3  border-b border-[#CED4DA] py-[20px] flex"> 
                    <div>
                      <img src={productTwo} alt="productLogo" className="w-[100px] h-[100px] mb-2" />
                      <div className="w-[100px] h-[28px] bg-[#22AD5C] rounded-lg px-[30px] py-[4px] text-white
                      text-[14px] font-semibold mt-[35px]">9.5/10</div>
                    </div>
                    <div className="ml-5">
                      <p className="text-[14px] mb-2">Dr. Dennis Gross Skincare</p>
                      <p className="text-[16px] font-semibold">DermInfusions™ Blur + Repair Cream with Hyaluronic Acid 
                        and Peptides</p>
                      <p className="text-[14px] text-[#1A8245] mt-3 font-semibold">Suitable for you!</p>
                    </div>
                  </div>
