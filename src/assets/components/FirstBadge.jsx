      ...
      <div className="w-[390px] h-[680px] overflow-auto rounded-xl shadow-lg flex flex-col bg-[#F4F7F2]">
        ...
        <div className="flex gap-3 flex-col justify-center items-center mt-6">
          ...
          <img
            src={badge}
            alt="rocketIcon"
            className="w-[201px] rounded-full shadow-2xl h-[201px] mt-4"
          />
          <h6 className="text-[18px] mt-5 leading-[26px] w-[330px] h-[78px] text-center ">
            You’ve earned your ‘First Skin Analysis’ badge. Welcome to the
            Project Glow skincare journey.
          </h6>
