      ...
      <div className="px-6 py-2 mt-7">
        ...
        <div className="">
          <p className="text-[14px] mb-4">
            ...
            back. These grooves then become features of the face, which are
            known as fine lines. They are closer to the surface of your skin
            compared to wrinkles.
          </p>
          <p className="text-[16px] font-bold">What to avoid</p>
          <p className="text-[16px] mb-4">
            Minimize exposure to direct sunlight and consider quitting smoking.
            Both habits can accelerate the skin aging process, diminishing its
            youthful appearance.
          </p>
          <p className="text-[16px] font-bold">Lifestyle advice</p>
          <p className="text-[16px] mb-4">
            Prioritizing sufficient sleep and staying well-hydrated from inside
            and outside are key to maintaining vibrant, youthful skin. Sleeping
            on your back is also recommended.
          </p>
        </div>
      </div>
    </div>
