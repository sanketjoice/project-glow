  ...
  return (
    <div className="flex flex-col items-center  justify-center  bg-gray-100 p-4">
      <div className="bg-white rounded-2xl shadow-lg p-6 max-w-[390px] h-[713px] text-center  self-center">
        <h1 className="text-[28px] leading-[40px] font-semibold text-black  text-center mt-[100px]">
          Congratulations!
        </h1>
        <p className="mt-3 text-[#000000] text-[18px] leading-7">
          You’ve just earned
        </p>
        <div className="flex items-center justify-center mt-4 ml-3">
          <img src={gem} alt="Diamond Icon" className="w-[96px] h-[96px]" />
          <span className="text-[28px] leading-[30px] mt-[50px] text-black ml-[-30px]">
            x 10
          </span>
        </div>
