    ...
    <div className="flex justify-center items-start min-h-screen bg-white overflow-y-auto">
      <div className="w-[390px] rounded-xl shadow-lg flex flex-col bg-[#F4F7F2]">
        ...
        <div className="bg-[#E2E7DF] flex p-4 mb-4 gap-4 z-10 fixed mt-[54px] w-full max-w-[390px]">
          <div>
            <h2 className="text-[18px] text-[#303030] font-semibold">
              Good morning Jane!
            </h2>
            <p className="text-[16px] text-black">How's your skin feeling?</p>
          </div>
          <button
            className="mt-1 w-[152px] h-[46px] border-[#303030] px-4 py-2 border rounded-[6px] bg-white ml-4 text-[14px]"
        ...
        <div className="flex justify-center space-x-8 bg-[#F4F7F2] p-4">
          {dates.map((date, index) => (
            <div key={date} className="flex flex-col items-center">
              <span
                className={`text-[#303030] text-[16px] ${
                  date === 18 ? "font-bold underline" : ""
                }`}
              >
                {date}
              </span>
              <div className="relative w-5 h-5 mt-1">
                ...
                {status[index] === "half" && (
                  <div
                    className="w-5 h-5 rounded-full bg-gray-300 overflow-hidden"
        ...
        <div className="flex justify-around items-start bg-[#F4F7F2] p-2 rounded-xl shadow-sm">
          ...
          <div className="flex flex-col items-start px-3">
            ...
            <div className="flex items-baseline">
              ...
              <span className="text-green-600 font-semibold ml-[2px] text-sm">
                Good!
              </span>
            </div>
          </div>
        ...
        <button
          className="w-[249px] h-[40px] bg-white border border-[#303030] rounded-lg py-2 px-[16px] text-[16px] 
      justify-center self-center font-medium mb-4"
        ...
        <div className="relative w-[350px] rounded-[10px] mx-4 h-[150px] overflow-hidden">
          ...
          <div className="relative h-full flex flex-col items-center justify-center p-4 space-y-3">
            ...
            <div className="relative">
              <button
                className="bg-[#FBBF24] hover:bg-yellow-500 text-gray-800 px-[28px] py-[8px] w-[213px] h-[40px] 
        ...
        <p className="text-[16px] font-semibold px-4 mt-6">
        ...
        <div className="flex px-4 gap-4 mt-4">
          <img
            src={pm}
            alt=""
            className="w-[56px] h-[56px] p-[10px] border border-[#BDBDBD] rounded-[10px]"
          />
          <img
            src={hydratedSkin}
            alt=""
        ...
        <div>
          <div className="w-[350px] p-4 border border-[#BDBDBD] rounded-xl bg-[#F4F7F2] ml-4 mt-6 flex items-start gap-4">
            ...
            <div>
              <h2 className="font-semibold text-[14px] text-[#303030]">
                Environmental Conditions
              </h2>
              <p className=" text-[14px] text-[#303030] mt-1">
                Pollution levels are elevated. Make sure to cleanse thoroughly
                tonight to remove impurities.
              </p>
            </div>
               
          </div>
          <div className="w-[350px] p-4 border border-[#BDBDBD] rounded-xl bg-[#F4F7F2] ml-4 mt-3 flex items-start gap-4">
            ...
            <div>
              <h2 className="font-semibold text-[14px] text-[#303030]">
                Hydration and Moisture Reminders
              </h2>
              <p className=" text-[14px] text-[#303030] mt-1">
                It’s a dry day today! Drink water regularly and consider a
                hydrating serum to keep your skin moisturized.
              </p>
            </div>
               
          </div>
          <div className="w-[350px] p-4 border border-[#BDBDBD] rounded-xl bg-[#F4F7F2] ml-4 mt-3 flex items-start gap-4">
            ...
            <div>
              <h2 className="font-semibold text-[14px] text-[#303030]">
                Product Usage Suggetions
              </h2>
              <p className=" text-[14px] text-[#303030] mt-1">
                To support your anti-aging goal, apply a retinol-based product
                tonight. Don’t forget to use SPF during the day!
              </p>
            </div>
               
          </div>
          <div className="w-[350px] p-4 border border-[#BDBDBD] rounded-xl bg-[#F4F7F2] ml-4 mt-3 flex items-start gap-4">
            ...
            <div>
              ...
              <p className=" text-[14px] text-[#303030] mt-1">
                Did you get enough rest? Poor sleep affects skin’s ability to
                repair itself, so aim for at least 7-8 hours.
              </p>
            </div>
          </div>
          <div className="w-[350px] p-4 border border-[#BDBDBD] rounded-xl bg-[#F4F7F2] ml-4 mt-3 flex items-start gap-4">
            ...
            <div>
              ...
              <p className=" text-[14px] text-[#303030] mt-1">
                Remember, products with fragrance may irritate sensitive skin.
